...
s3_client.download_file(os.environ['bucketNameV1'],'webcheck.py', '/tmp/webcheck.py')
...
def api_Handler(event, context):
    ...
    bucktToTableName =  os.environ['S3TotableV1']
    ...
    # Parse url primary key value & pass to function to read from DB
        ...
        table.put_item(TableName = os.environ['S3TotableV1'],
                        Item = {
                            "id_": "url",
                            "url" : event['body']
                        })
        ...
        InsertedResponse = table.put_item(TableName=os.environ['S3TotableV1'], Item={'id_': "url",'url': new_url})
